...
```
drwxr-xr-x  gaming/        → Estrategia, simulación, RPGs
drwxr-xr-x  cycling/       → Rutas urbanas y montaña en Santiago
drwxr-xr-x  coffee/        → Especialidad, V60, aeropress
drwxr-xr-x  cars/          → Mecánica, tuning, conducción técnica
drwxr-xr-x  electronics/   → Proyectos con microcontroladores y hardware
drwxr-xr-x  ai/            → LLMs, agentes, RAG, fine-tuning local
```
